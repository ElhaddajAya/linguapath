...
import {
  Check, X, Settings, Users, Search, Globe,
  ArrowLeft, Clapperboard, UserX, UserCheck, Loader2,
} from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-10 py-5 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          <div>
            ...
            >
              ...
              <span>Scénarios</span>
              <Clapperboard size={11} className="ml-0.5" />
            </Link>
            ...
            <p className="text-warm-500 text-xs sm:text-sm mt-1">
              <span className="text-green-600 font-medium">{totalActifs} actif{totalActifs !== 1 ? "s" : ""}</span>
              {" · "}
              <span className="text-warm-400">{totalInactifs} désactivé{totalInactifs !== 1 ? "s" : ""}</span>
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-warm-200 shadow-soft p-10 sm:p-12 text-center">
            <Search size={40} className="text-warm-300 mx-auto mb-4" />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`text-xs px-2.5 py-1 rounded-full font-medium shrink-0 inline-flex items-center gap-1
                        ${user.role === "admin" ? "bg-purple-50 text-purple-600" : "bg-warm-100 text-warm-500"}`}>
                        {user.role === "admin"
                          ? <><Settings size={11} /> Admin</>
                          : "User"}
