    ...
    return (
      <div className="min-h-screen bg-warm-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-warm-200 shadow-soft
          ...
          <h2 className="text-2xl font-bold text-warm-900 mb-3">Vérifiez votre email !</h2>
    ...
    <div className="min-h-screen bg-warm-50 flex">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-orange-500 to-orange-600
        ...
        <div className="text-white text-center">
          ...
          <p className="text-orange-100 text-lg">
            Choisis ta langue,<br />découvre ton niveau.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-semibold text-warm-900 mb-1">Crée ton compte</h2>
          <p className="text-sm text-warm-500 mb-7">Rejoins LinguaPath et commence à apprendre</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-warm-700">Nom complet</label>
